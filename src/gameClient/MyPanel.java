...
public class MyPanel extends JPanel {
    ...
    MyPanel(){
        ...
        this.agent=new ImageIcon("./data/Pikachu.png ").getImage();
        this.squirtle=new ImageIcon("./data/Squirtle.png ").getImage();
        ...
        if(fs!=null) {
            ...
            while(itr.hasNext()) {
                ...
                if(c!=null) {
                    ...
                    g.drawImage(squirtle,(int)fp.x()-r, (int)fp.y()-r, 3*r, 3*r,null);
